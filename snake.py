...
border = [Entity(model="cube", scale=(15,0.5,1),position=(0,4.2,0), collider="box", color=color.red),Entity(model="cube", scale=(15,0.5,1),position=(0,-4.2,0), collider="box",color=color.red),
          Entity(model="cube", scale=(0.5,15,1),position=(7.5,0,0), collider="box",color=color.red),Entity(model="cube", scale=(0.5,15,1),position=(-7.5,0,0), collider="box", color=color.red)]
